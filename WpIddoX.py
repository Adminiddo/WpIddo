...
Copyright © 2022 IddoDios <admin@iddoaxell.net>
...
NAME = "Tools WPBF By IDDO X-PLOID"
BANNER = """\
      .---.        .-----------
     /     \  __  /    ------
    / /     \(  )/    -----
...
//          //..\\   %s
       ====UU====UU==========================
           '//||\\`
             ''``
""" % (NAME)
VERSION = "2.1.2" # <major> <minor> <path>
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
      ...
      epilog="Copyright © 2022 Iddo - Powered by Dios De La Distraction ",
    )
